...
print("만렙까지 더 필요한 아케인 심볼은", ((maxLv) - Arcane(SymLv).AccNeedLv()) - UserSym, "개 입니다")
...
if SymType == 1 :
    if UserMesoTotal < symbolMeso_1stSym :
        print("만렙까지 더 필요한 메소는", math.trunc(resultMeso_100M_1stSym / 10000),"억", resultMeso_10K_1stSym,"만 메소 입니다")
    else :
        print("만렙까지 필요한 메소는 충분합니다")
elif SymType == 2 :
    if UserMesoTotal < symbolMeso_2ndSym :
        print("만렙까지 더 필요한 메소는", math.trunc(resultMeso_100M_2ndSym / 10000),"억", resultMeso_10K_2ndSym,"만 메소 입니다")
    else :
        print("만렙까지 필요한 메소는 충분합니다")
elif SymType == 3 :
    if UserMesoTotal < symbolMeso_3rdSym :
        print("만렙까지 더 필요한 메소는", math.trunc(resultMeso_100M_3rdSym / 10000),"억", resultMeso_10K_3rdSym,"만 메소 입니다")
    else :
        print("만렙까지 필요한 메소는 충분합니다")
else :
    if UserMesoTotal < symbolMeso_otherSym :
        print("만렙까지 더 필요한 메소는", math.trunc(resultMeso_100M_otherSym / 10000),"억", resultMeso_10K_otherSym,"만 (메소 입니다")
    else :
        print("만렙까지 필요한 메소는 충분합니다")